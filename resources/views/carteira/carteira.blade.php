...
<form action="{{ route('carteira.store') }}" method="POST">
  ...
  <div class="row">
  <div style="width: 400px; height: 500px; overflow-y:auto; overflow-x: hidden;" class=" card border border-dark rounded scrollBoxDespesa">
    <div class="card-header">
    <div class="row">
        <div class="headerText">Despesas</div>
        <div href="" class="btn btn-dark scrollBoxNewButtonDespesa"><span class="material-symbols-outlined">
add
</span></div>
      </div>
    </div>
  ...
  <div style="width: 400px; height: 500px; overflow-y:auto; overflow-x: hidden;" class=" card border border-dark rounded scrollBoxReceita">
    <div class="card-header">
      <div class="row">
        <div class="headerText">Receita</div>
        <div href="" class="btn btn-dark scrollBoxNewButtonReceita"><span class="material-symbols-outlined">
add
</span></div>
      </div>
    </div>
